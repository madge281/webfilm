...
<title>ONLINE ENTERRTAINMENT</title>
				...
				<div class="col-6 d-flex justify-content-end align-items-center">
					<form action="" class="tm-text-primary">
						Page <input type="text" value="1" size="1"
							class="tm-input-paging tm-text-primary"> of 4
					</form>
				</div>
			</div>
			...
			<div class="row tm-mb-90 tm-gallery">
				...
				<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
					<figure class="effect-ming tm-video-item">
						<img src="<c:url value ='/templates/user/img/img-01.jpg'/>"
				...
				<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
					<figure class="effect-ming tm-video-item">
						<img src="<c:url value ='/templates/user/img/img-02.jpg'/>"
							alt="Image" class="img-fluid">
						<figcaption
							class="d-flex align-items-center justify-content-center">
							<h2>Clocks</h2>
				...
				<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
					<figure class="effect-ming tm-video-item">
						<img src="<c:url value ='/templates/user/img/img-04.jpg'/>"
							alt="Image" class="img-fluid">
						<figcaption
							class="d-flex align-items-center justify-content-center">
							<h2>Clocks</h2>
